!(function (a) {
  ...
  function s() {
    for (var a = speechSynthesis.getVoices(), b = 0; b < a.length; b++)
      p.push(new r(a[b].name, a[b].lang));
  }
  var i,
    j,
    k,
  ...
  if (
    ...
    "undefined" != typeof speechSynthesis &&
      ...
      (speechSynthesis.onvoiceschanged = s),
    ...
    x = {
      speak: function (p) {
        function A(a) {
          ...
          jQuery(a)
            ...
            jQuery(a)
              ...
              .each(function () {
                (d = jQuery(this).data("articulate-prepend")),
            ...
            jQuery(a)
              ...
              .each(function () {
                (d = jQuery(this).data("articulate-append")),
            ...
            i++,
              i <= 4 &&
                jQuery(a)
                  ...
                  .each(function () {
                    e[j]
                      ? (jQuery(this).prepend(e[j].prepend + " "),
                        jQuery(this).append(" " + e[j].append))
                      : (jQuery(this).prepend(y[j].prepend + " "),
                        jQuery(this).append(" " + y[j].append));
                  });
          return (
            jQuery(a)
            ...
            jQuery(a)
              ...
              .addBack("figure")
              .each(function () {
                (d = jQuery(this).find("figcaption").html()),
                  (f = e.figure ? e.figure.prepend : y.figure.prepend),
                  void 0 != d &&
                    "" !== d &&
                    jQuery("<div>" + f + " " + d + ".</div>").insertBefore(
                      this
                    ),
                  jQuery(this).remove();
              }),
            jQuery(a)
              ...
              .each(function () {
                ...
                var a = jQuery(this).parent(),
                  b = a.get(0).tagName;
                if (
                  ((f = e.img ? e.img.prepend : y.img.prepend),
                  void 0 !== d && "" != d)
                )
                  if ("PICTURE" == b) {
            ...
            jQuery(a)
              ...
              .addBack("table")
              .each(function () {
                (d = jQuery(this).find("caption").text()),
                  (f = e.table ? e.table.prepend : y.table.prepend),
                  void 0 !== d &&
                    "" != d &&
                    jQuery("<div>" + f + " " + d + ".</div>").insertBefore(
                      this
            ...
            jQuery(a)
              ...
              .each(function () {
                (d = jQuery(this).data("articulate-swap")),
                  jQuery(this).text(d);
              }),
            jQuery(a)
        ...
        function B(a) {
          for (
            var b, c, f, g, h, a;
            a.indexOf("<!-- <articulate>") != -1 &&
            ((b = a.indexOf("<!-- <articulate>")),
            (c = a.indexOf("</articulate> -->", b)),
            c != -1);

          )
            (f = a.substring(b + 17, c)),
              (g = a.substring(0, b)),
              (h = a.substring(c + 17)),
              (a = g + " " + f + " " + h);
          (a = a.replace(/<!--[\s\S]*?-->/g, "")),
          ...
          e.q
            ? ((a = a.replace(/“/g, e.q.prepend + " ")),
              (a = a.replace(/”/g, " " + e.q.append)))
            : ((a = a.replace(/“/g, y.q.prepend + " ")),
              (a = a.replace(/”/g, " " + y.q.append))),
            (a = a.replace(/—/g, ", ")),
            (a = a.replace(/--/g, ", "));
        ...
        var u,
          v,
          x,
          s = (a.extend({}, a.fn.articulate.defaults, p), ""),
          y = new Array();
        (y.q = new q("quote,", ", unquote,")),
          (y.ol = new q("Start of list.", "End of list.")),
          (y.ul = new q("Start of list.", "End of list.")),
          (y.blockquote = new q("Blockquote start.", "Blockquote end.")),
          (y.img = new q(
            "There's an embedded image with the description,",
            ""
          )),
          (y.table = new q("There's an embedded table with the caption,", "")),
          (y.figure = new q(
        ...
        return "speechSynthesis" in window
          ? window.speechSynthesis.speaking
            ...
            : (this.each(function () {
              ...
              (t.volume = o),
              w &&
                (t.voice = speechSynthesis.getVoices().filter(function (a) {
      ...
      volume: function () {
        var a = arguments[0];
        return (
          a >= 0 && a <= 1 ? (k = a) : void 0 === a && ((k = void 0), (o = h)),
          this
        );
      },
      ignore: function () {
      ...
      replace: function () {
        ...
        for (
          var b = 0;
          b < a &&
          (d.push(arguments[b], arguments[b + 1]), (b += 2), a - b != 1);
      ...
      getVoices: function () {
        ...
        void 0 !== arguments[1] && (b = arguments[1]),
          a.append(
            jQuery(
        ...
        for (var c = 0; c < p.length; c++) {
          ...
          (d.textContent = p[c].name + " (" + p[c].language + ")"),
            d.setAttribute("value", p[c].name),
            d.setAttribute("data-articulate-language", p[c].language),
            a.find("select").append(d);
        }
        return (
  ...
  a.fn.articulate = function (a) {
    return x[a]
      ? x[a].apply(this, Array.prototype.slice.call(arguments, 1))
      : "object" != typeof a && a
      ? void jQuery.error(
          "Method " + a + " does not exist on jQuery.articulate"
        )
